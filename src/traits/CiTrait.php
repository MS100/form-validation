...
Trait CiTrait
{
    ...
    public function matches($str, array $indexes, $field)
    {
        ...
        $data = $this->getValidationDataElement($subject);
    ...
    public function valid_url($str)
    {
        ...
        if (preg_match('/^\[([^\]]+)\]/', $str, $matches) && !is_php('7') && filter_var($matches[1], FILTER_VALIDATE_IP,
    ...
    public function valid_email($str)
    {
        ...
        return filter_var(strtolower($str), FILTER_VALIDATE_EMAIL);
    }
    ...
    public function valid_emails($str)
    {
        ...
        foreach (explode(',', $str) as $email) {
            $email = trim($email);
            if ($email !== '') {
                if (($email = $this->valid_email($email)) === false) {
                    return false;
                } else {
                    $res[] = $email;
                }
    ...
    {
        return in_array((string)$value, explode(',', $list), true);
    }
